...
In particular, we will learn how it may make the covariance non-zero. 
...
We call random effects **random** because we assume a probability distribution of the effects, and $u_j \sim \text{iid}(0, \sigma^2_u)$. 
This assumption represents the notion that these effects come from a larger group.  
